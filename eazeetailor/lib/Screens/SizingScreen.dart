                ...
                child: Container(
                  ...
                  child : Row(
                    ...
                    children: <Widget> [
                      Container(
                        height: 140,
                        child: Padding(padding: EdgeInsets.fromLTRB(10, 15, 0, 0),
                          child: Column(
                            // mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget> [
                                Container(
                                  child: Text(widget.memberSize[index].name.toString(),
                                ...
                                Padding(
                                   ...
                                   //for (var i in text),
                                 Text( 'Body Length : ' + 
                                  widget.memberSize[index].sizes.body.toString()
                                  + '\nSleeve Length : ' + widget.memberSize[index].sizes.sleeve.toString()
                                  + '\nChest : ' + widget.memberSize[index].sizes.chest.toString(),
